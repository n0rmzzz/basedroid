...
import com.tinywebgears.basedroid.dao.MySQLiteHelper;
...
public class ItemDetailFragment extends SherlockFragment
{
    ...
    public void onCreate(Bundle savedInstanceState)
    {
        ...
        mItemUri = (savedInstanceState == null) ? null : (Uri) savedInstanceState
                .getParcelable(CommentsContentProvider.CONTENT_ITEM_TYPE);
        if (getArguments() != null && getArguments().containsKey(CommentsContentProvider.CONTENT_ITEM_TYPE))
            mItemUri = getArguments().getParcelable(CommentsContentProvider.CONTENT_ITEM_TYPE);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
    {
        ...
        mItemDetailsTextView = ((TextView) rootView.findViewById(R.id.item_detail));
        if (mItemUri != null)
            fillData(mItemUri);
        return rootView;
    }
    ...
    {
        String[] projection = { MySQLiteHelper.COLUMN_ID, MySQLiteHelper.COLUMN_COMMENT };
        Cursor cursor = getActivity().getContentResolver().query(uri, projection, null, null, null);
        if (cursor != null)
        {
            cursor.moveToFirst();
            Long id = cursor.getLong(cursor.getColumnIndexOrThrow(MySQLiteHelper.COLUMN_ID));
     ...
     * activities to be notified of item deletion.
     */
